...
kruskal_result <- kruskal.test(MUT ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$MUT, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(UMUT ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$UMUT, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(CHGREG ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$CHGREG, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(UCHGREG ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$UCHGREG, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(CHGGEN ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$CHGGEN, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(UCHGGEN ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$UCHGGEN, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(CNV ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$CNV, data$Color, method = "bonferroni")  
...
kruskal_result <- kruskal.test(UCNV ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$UCNV, data$Color, method = "bonferroni") 
...
kruskal_result <- kruskal.test(CNVG ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$CNVG, data$Color, method = "bonferroni") 
...
kruskal_result <- kruskal.test(UCNVG ~ Color, data = data)
# Display the result
print(kruskal_result)
# Perform post-hoc test
dunn_result <- dunn.test(data$UCNVG, data$Color, method = "bonferroni") 
...
ggsave("strainbystrain_background.png", combined_plot, width = 20, height = 20, dpi = 300)
